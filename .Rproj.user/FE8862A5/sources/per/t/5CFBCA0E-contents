...
read_FRAM_data<-function(FRAM_directory, FRAM_filename){
  ...
  if (!"readxl" %in% installed.packages()) install.packages("readxl"); library("readxl")
  if (!"tidyxl" %in% installed.packages()) install.packages("tidyxl"); library("tidyxl")
  if (!"magrittr" %in% installed.packages()) install.packages("magrittr"); library("magrittr")
